...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring dark:focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900",
  {
    variants: {
      variant: {
        default:
        ...
        secondary:
          "border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80 dark:bg-slate-700 dark:text-white dark:hover:bg-slate-600",
        destructive:
        ...
        outline:
          "text-foreground dark:text-white border-border dark:border-slate-600 hover:bg-accent dark:hover:bg-slate-800",
        success:
